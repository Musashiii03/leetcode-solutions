<h2><a href="https://leetcode.com/problems/single-threaded-cpu">1962. Single-Threaded CPU</a></h2><h3>Medium</h3><hr><p>You are given <code>n</code>ââââââ tasks labeled from <code>0</code> to <code>n - 1</code> represented by a 2D integer array <code>tasks</code>, where <code>tasks[i] = [enqueueTime<sub>i</sub>, processingTime<sub>i</sub>]</code> means that the <code>i<sup>ââââââth</sup></code>ââââ task will be available to process at <code>enqueueTime<sub>i</sub></code> and will take <code>processingTime<sub>i</sub></code><sub> </sub>to finish processing.</p>
